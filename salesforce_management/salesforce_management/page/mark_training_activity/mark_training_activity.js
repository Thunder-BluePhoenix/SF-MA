frappe.pages['mark-training-activity'].on_page_load = function(wrapper) {
...
Activity Submitted Succcessfully.
    ...
    let img_list = [];
    // Add the fields
    var trainingTypeField = addField('training_type', 'Training Type', 'Link');
    var startDateTimeField = addField('start_datetime', 'Start Datetime', 'Datetime');
	var endDateTimeField = addField('end_datetime', 'End Datetime', 'Datetime');
    ...
    var submitButton = page.set_primary_action(__('Submit'), function() {
        ...
        var trainingType = trainingTypeField.get_value();
        var startDateTime = startDateTimeField.get_value();
        var endDateTime = endDateTimeField.get_value();
        ...
        frappe.call({
            ...
            callback: function(response) {
                if (response.message) {
                    ...
                    var newDoc = frappe.model.get_new_doc('Non Promoter Training Activity');
                    newDoc.training_type = trainingType;
                    newDoc.start_date_time = startDateTime;
                    newDoc.end_date_time = endDateTime;
