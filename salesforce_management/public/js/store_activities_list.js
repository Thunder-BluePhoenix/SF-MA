frappe.views.ListView = class ListView extends frappe.views.ListView {
    ...
    get_list_row_html_skeleton(left = "", right = "", details = "", employee_name="") {
        ...
        if (this.doctype === "Store Activities") {
    		...
    		return `
    			<div class="list-row-container" tabindex="1">
    				...
    				<div class="level list-row details-row">Activity: ${details}</div>
